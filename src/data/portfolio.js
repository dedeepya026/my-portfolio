...
export const portfolioData = {
    ...
    about: {
        text: [
            "I am a Computer Science undergraduate at VIT Chennai with a strong interest in Machine Learning, Deep Learning, Software Development and Data Analysis. I have research experience as a Research Intern, where I worked on predictive healthcare models using various ML and DL techniques.",
            "My project work spans across efficient deep learning, secure systems, and data-driven analytics. I developed a RoBERTa-based text classification model using LoRA, achieving 88.1% accuracy on AG News while fine-tuning only 0.5% of parameters, reducing computational overhead by over 99% under a strict parameter budget. I also built KryptVault, a zero-knowledge password manager implementing AES-256 encryption and PBKDF2-based key derivation with secure RESTful APIs, JWT authentication, and client-side encryption for enhanced data privacy. Additionally, I designed a customer behavior analytics pipeline using Python, SQL, and Power BI to extract insights on purchasing patterns and customer segmentation, enabling data-driven business decisions. Alongside these, I have developed an industry-specific dynamic risk index prediction system using ensemble learning techniques to model economic risk across sectors, a full-stack MERN-based URL shortener with scalable backend architecture, and an NLP-driven cyberbullying detection system focused on privacy-aware deployment.",
            "I am proficient in Python, Java, and C/C++, with strong foundations in core computer science subjects including Data Structures and Algorithms, Operating Systems, DBMS, and Computer Networks."
            "I have published an IEEE paper on non-invasive blood glucose monitoring using Terahertz Spectroscopy and earned certifications such as Microsoft Azure AI Fundamentals. Beyond academics, I have held leadership roles as the Treasurer of the Dance Club and as a Management Lead and Marketing Team Member at VIT Chennai. I am actively seeking opportunities in AI/ML, Data Science, and Software Development to contribute and grow in collaborative, challenging environments."
        ],
